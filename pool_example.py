...
#################################################################################
# Define callback function for *Only*-1 process to deal with the output of func_ 
def callback_(output_):
    ...
    CNT += 1
    if CNT % PRINT_FREQ == 0:
        print(time.strftime("%Y-%m-%d %H:%M:%S", time.localtime()), f"Handled {CNT}.")
...
if __name__ == "__main__":
    ...
    """ Method No.2: if need for callback and load progress bar, recommended."""
